      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="merix-card merix-card-hover p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            <div className="text-xs font-mono font-bold gradient-text">STEP 01</div>
        ...
        <div className="merix-card merix-card-hover p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            <div className="text-xs font-mono font-bold gradient-text">STEP 02</div>
            <h3 className="font-bold text-base text-[var(--text-primary)]">
        ...
        <div className="merix-card merix-card-hover p-6 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            <div className="text-xs font-mono font-bold gradient-text">STEP 03</div>
            <h3 className="font-bold text-base text-[var(--text-primary)]">
