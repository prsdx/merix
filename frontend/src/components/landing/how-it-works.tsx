...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-16 scroll-mt-20">
      <Stagger className="space-y-4 text-center max-w-2xl mx-auto mb-12" gap={0.12}>
        <StaggerItem>
      ...
      <Stagger className="grid grid-cols-1 md:grid-cols-3 gap-6" gap={0.14}>
        {/* Step 1: Define Rubric */}
        <StaggerItem className="h-full">
          <SpotlightCard className="p-6 space-y-4 flex flex-col justify-between h-full">
